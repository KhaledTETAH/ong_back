...
from .serializers import CandidateRegisterSerializer, LogoutSerializer, OrganizationRegisterSerializer, UserSerializer
...
class CandidateRegisterView(APIView):
	...
	def post(self, request):
		...
		return SuccessResponse(UserSerializer(user).data, "Candidate account created.", status=201)
